...
if(!isset($_SESSION['edit_account'])){
    ...
    if(isset($_POST['user_update'])) {
        ...
        $update_query = "UPDATE `user_table` SET username='$username', user_email='$user_email', user_address='$user_address', user_mobile='$user_mobile', user_image='$user_image' WHERE user_id='$user_id'";
